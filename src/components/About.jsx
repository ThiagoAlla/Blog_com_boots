          ...
          <Card className="custom-card p-4 shadow-lg border-0">
            <Card.Body>
              <Card.Title className="custom-title text-center text-3xl">
                Sobre o Blog de Xadrez
              </Card.Title>
              <Card.Text className="mt-3">
                Este blog foi criado para celebrar os maiores jogadores de xadrez da história. Aqui, você encontra informações detalhadas sobre cada um deles e suas conquistas.
              </Card.Text>
              <h2 className="text-secondary mt-4">Integrantes do Blog:</h2>
              <ul className="list-unstyled text-secondary">
                <li>Thiago Allan – Entusiasta de Xadrez e Desenvolvedor & Data Engineer</li>
